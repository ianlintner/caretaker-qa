...
- Caretaker pin upgraded from v0.19.4 to v0.19.6 (persistent SQLite fleet registry, fleet CLI commands, admin dashboard wiring, frontend Alerts + FleetDetail pages).
